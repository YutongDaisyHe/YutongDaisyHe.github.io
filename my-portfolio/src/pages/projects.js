...
//                         </div>
//                         <div>
//                             <img src={recipeFridgeImage} alt="GoalForIt App Screenshot 2" className="project-image" />
//                         </div>
//                     </Carousel>
//                 </div>
//                 <div className="project-content">
...
//                         </div>
//                         <div>
//                             <img src={goalForItImage} alt="RecipeFridge App Screenshot 2" className="project-image" />
//                         </div>
//                     </Carousel>
//                 </div>
//                 <div className="project-content">
...
//                         </div>
//                         <div>
//                             <img src={goalForItImage} alt="Social Media App Screenshot 2" className="project-image" />
//                         </div>
//                     </Carousel>
//                 </div>
//                 <div className="project-content">
...
//                         </div>
//                         <div>
//                             <img src={goalForItImage} alt="NLP Project Screenshot 2" className="project-image" />
//                         </div>
//                     </Carousel>
//                 </div>
//                 <div className="project-content">
